      ...
      ******************************************************************
      * DCLGEN TABLE(TOPTOT.INCENTIVES)                               *
      ...
      ******************************************************************
           EXEC SQL DECLARE KT_INCENTIVES TABLE
           ...
           EXEC SQL DECLARE KT_LOCATION TABLE
           ( ZIP_CODE                      CHAR(6),
             COST_FACTOR                         DECIMAL(6, 2)
           ) END-EXEC.
      ******************************************************************
      * COBOL DECLARATION FOR TABLE TOPTOT.INCENTIVES                 *
      ******************************************************************
       01  KTDCL-DEMOTAB1.
      *    *************************************************************
           10 EMP-NUM              PIC X(5).
      ...
      ******************************************************************
      ******************************************************************
      * COBOL DECLARATION FOR TABLE TOPTOT.KT_LOCATION                 *
      ******************************************************************
       01  KTDCL-KT_LOCATION.
      *    *************************************************************
           10 ZIP_CODE           PIC X(6).
      *    *************************************************************
           10 COST_FACTOR               PIC S9(4)V9(2) USAGE COMP-3.
           ...
           EXEC SQL DECLARE JOIN_CURSOR CURSOR FOR
               SELECT COST_FACTOR
               FROM KT_LOCATION, KT_INCENTIVES
               WHERE ZIP_CODE = ZIP
           END-EXEC.
                   ...
                   ELSE
                      IF DELETED
                          ...
                          IF CURSOR-FETCHED
                            ...
                            WS-CURSOR-SWITCH
                            EXEC SQL DELETE FROM KT_INCENTIVES
...
*********
      ...
      ***
                 EXEC SQL OPEN JOIN_CURSOR END-EXEC
                 EXEC SQL FETCH JOIN_CURSOR INTO
                     :COST_FACTOR
                 END-EXEC
                 IF SQLCODE NOT EQUAL TO 0 THEN
                     MOVE 1.0 TO COST_FACTOR
      ...
      *          MOVE CITY-TEXT TO WA-EMP-CITY
                 ...
                 MOVE ZIP OF KTDCL-DEMOTAB1   TO WA-EMP-ZIP
                 MOVE HOURS TO WA-EMP-HOURS
       ...
       9100-CHECK-PARM.
           ...
           IF SQLCODE NOT EQUAL TO 0
             MOVE SQLCODE TO WS-DISPLAY-SQLCODE
              ...
              WS-DISPLAY-SQLCODE
           END-IF.
           DISPLAY 'NUMBER OF EMPLOYEES IN KT_INCENTIVES= ',
              NUMBER-OF-EMPLOYEES.
