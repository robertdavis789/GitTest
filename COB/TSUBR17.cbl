...
000900*      CALLED FROM    TPROG17
000900*      CALLED FROM    TPROG17
001000*      WITH COPYLIB   TCPYB17 (LINKAGE AREA)
001100* ======================================================
001200*  ISPW (TM)
...
002100*  ********  **********  *******
002200*  96/01/24  ISPW        NEW PROGRAM Change
002300* ======================================================
...
003200********************************************************
003300*  FILES USED:
003400*   INPUT   JUST SOME DUMMY DATA TO READ IN peter
003500********************************************************
